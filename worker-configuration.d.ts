/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config apps/api/wrangler.jsonc` (hash: 219307c6cfc55d6fe0bdd4bbe7e962a6)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "EngagementCounter";
	}
	interface Env {
		...
		SERVICE_MODE: "in-process";
		AUTH_MODE: "demo";
		ENGAGEMENT_COUNTERS: DurableObjectNamespace<import("./apps/api/src/index").EngagementCounter>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SERVICE_MODE" | "AUTH_MODE">> {}
}
